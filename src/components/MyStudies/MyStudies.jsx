const MyStudies = () => {
  return (
    <section className='flex flex-col items-start p-8 bg-[#111] text-white lg:px-25 pt-25' id="mis-estudios">
...
const StudyCard = ({titulo, lugar, fechaInicio, fechaFin, descripcion}) => {
    return (<>
        <div className='shadow-md w-full border-b-1 border-stone-700 pb-2 lg:border-none lg:shadow-none'>
            ...
            <p className='mt-2 text-sm lg:text-l text-gray-400 lg:w-150'>{descripcion}</p>
        </div>
