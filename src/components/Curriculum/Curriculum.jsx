...
const Curriculum = ({ ref }) => {
  return (
    <div
      ref={ref}
      className="bg-[#111] w-full flex flex-col p-8 lg:px-25 pt-30"
      id="CV"
    >
      ...
      <div className="flex font-[800] gap-5">
        <span className="flex flex-col justify-center items-center w-full">
          <img
            className="h-30 object-contain lg:h-70 "
            src={argentina}
            alt="Argentina"
          />
          <a
            href={CurriculumPDF}
            download="JeronimoCoriglianoCV_Es"
            className="w-full h-10 bg-[#00ffaa] rounded-lg text-center text-black p-2  lg:w-fit"
          >
            Descargar
          </a>
        </span>
        <span className="flex flex-col justify-center items-center w-full">
          ...
          <a
            href={CurriculumENGPDF}
            download="JeronimoCoriglianoCV_En"
            className="w-full h-10 bg-[#00ffaa] rounded-lg text-center text-black p-2 lg:w-fit"
          >
            Descargar
          </a>
